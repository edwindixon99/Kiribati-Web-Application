...
const Navigation = () => (
  ...
  <Navbar bg="light" variant="light">
    <Container>
    <Navbar.Brand><NavLink to='/' className="nav-link"><img src="https://upload.wikimedia.org/wikipedia/commons/c/cb/Kiribati_National_Emblem.png" width="30" height="30" className="d-inline-block align-top" alt="" />Translations</NavLink></Navbar.Brand>
